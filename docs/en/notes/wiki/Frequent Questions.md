...
The latest release version of the mod is: `2.5.2`

The mod works on:

<Card title="Version 2.5.2" icon="icon-park-outline:tag">
...
- Did you actually have the mod installed?
- Did you have the latest version (2.5.2) of the mod installed? Most new models requires mod version 2.2.2 or above. Version 1.1.5 is no longer supported!
...
If you encountered this, please check if your YSM is up to date (the latest version is 2.5.2). If not, please update.
