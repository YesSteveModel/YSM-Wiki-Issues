...
::: tip
目前最新版的 Yes Steve Model 版本号为 **2.5.3**
:::

::: tip
**2.5.3 版本**同时支持 1.20.1 Forge，1.20.1/1.21.1 Fabric 和 1.21.1 NeoForge
共计四个版本。
...
目前客户端支持 Windows x64 、Linux x64 和 Android ARM64 系统，服务端支持 Windows 和 Linux x64 系统。其他平台和架构的支持也在逐步进行中，后续有完成进度时会随时进行公告。
