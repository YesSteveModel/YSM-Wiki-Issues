...
|      `swing:fishing_rod`、`swing:fishing_rod`      | 丢出/收回钓鱼竿时播放（2.3.0 新增） |
...
|    `hold_mainhand:fishing_rod` 、`hold_offhand:fishing_rod`    |           持有钓鱼竿时播放（2.3.0 新增）           |
|                   `hold_mainhand:fishing`                    | 持有抛出鱼钩的鱼竿时播放<br>（==特殊，仅此一个==） |
|    `hold_mainhand:slashblade` 、`hold_offhand:slashblade`    |           持有拔刀剑时播放（2.3.0 新增）           |
