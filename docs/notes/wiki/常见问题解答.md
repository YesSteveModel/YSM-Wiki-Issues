...
<Card title="2.5.2 版本" icon="icon-park-outline:tag">
...
- 请确认您是否安装 YSM 模组？
- 请确认您安装的 YSM 版本是否为最新版（最新版为 2.5.2）。绝大多数新模型需要 2.2.2 及以上的版本来运行，1.1.5 版本将不再支持！
...
如果您遇到了这种情况，请检查你的 YSM 版本是否为最新版（最新版为 2.5.2），如果不是，请更新 YSM 模组。
...
- 如果您是安卓版 JE 启动器的作者……
  ...
  由于安卓的权限限制，YSM 需要一个特殊的环境变量 `MOD_ANDROID_RUNTIME` 才能正常运行，用于放置 YSM 运行所需要的文件。
:::
